    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-teal-700 to-teal-800 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">Đội ngũ Y Bác sĩ</h1>
          <p className="text-xl text-center max-w-3xl mx-auto text-teal-100 mb-8">
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredDoctors
                    ...
                    .map((doctor: User) => {
                      const approvedCerts: Certification[] = (doctor.certifications || []).filter(cert => cert.status === 'approved');
                      const approvedExps: Experience[] = (doctor.experiences || []).filter(exp => exp.status === 'approved');
                ...
                <div className="mt-8 flex justify-center">
                  <nav className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-1 rounded-md bg-teal-100 text-teal-700 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-teal-200"
                    >
                      Trước
                    </button>
                    <span className="px-4 py-1 rounded-md bg-teal-600 text-white">
                      {currentPage}
                    </span>
                    <button
                      onClick={() => setCurrentPage(prev => {
                        const maxPage = Math.ceil(filteredDoctors.length / doctorsPerPage);
