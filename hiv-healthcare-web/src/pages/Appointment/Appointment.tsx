      ...
      <div className="bg-gradient-to-r from-teal-800 to-green-900 text-white py-16">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
            Vui lòng điền đầy đủ thông tin bên dưới để đặt lịch khám với bác sĩ chuyên khoa HIV. Mọi thông tin của bạn
        ...
        {serviceLoading ? (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex justify-center items-center py-8">
              ...
              <span className="text-teal-600 text-lg font-medium">Đang tải thông tin dịch vụ...</span>
            </div>
          </div>
        ) : service ? (
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <label className="flex items-center cursor-pointer group">
                ...
                <div className="ml-4">
                  <span className="text-lg font-semibold text-gray-800">Đặt lịch ẩn danh</span>
                  <p className="text-sm text-gray-600 mt-1">
                    Bảo vệ thông tin cá nhân của bạn với tùy chọn đặt lịch ẩn danh
                  </p>
                </div>
              </label>
            </div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {loadingDoctors ? (
                        ...
                        <option disabled>Không có bác sĩ nào khả dụng vào ngày này</option>
                      ) : (
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-700 leading-relaxed">
                    Mọi thông tin của bạn sẽ được bảo mật tuyệt đối theo tiêu chuẩn y tế.
                    {isAnonymous &&
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-green-800 mb-2">Xác nhận lịch hẹn</h4>
                  <p className="text-green-700 leading-relaxed">
                    Sau khi đặt lịch thành công, chúng tôi sẽ liên hệ với bạn trong vòng 24 giờ để xác nhận lịch hẹn và
                    cung cấp hướng dẫn chuẩn bị.
                  </p>
                </div>
              </div>
            </div>
