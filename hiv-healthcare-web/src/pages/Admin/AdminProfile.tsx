    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-teal-50">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Đang tải thông tin quản trị viên...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Thông tin quản trị viên</h1>
          </div>
          <p className="text-gray-600">Quản lý và cập nhật thông tin cá nhân của quản trị viên</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-700">Tên quản trị viên <span className="text-red-500">*</span></label>
