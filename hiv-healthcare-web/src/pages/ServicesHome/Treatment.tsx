...
const Treatment: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-teal-100 mb-8">
              Chúng tôi cung cấp dịch vụ điều trị ARV toàn diện, kết hợp với
              chăm sóc y tế chất lượng cao và hỗ trợ tâm lý để giúp bạn duy trì
              sức khỏe tốt nhất.
            </p>
            <Link
              to="/appointment"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Phác đồ điều trị ARV hiện đại, được cá nhân hóa theo tình trạng
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Kiểm tra tải lượng virus thường xuyên và đánh giá hiệu quả điều
              trị để đảm bảo kết quả tốt nhất.
            </p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Đội ngũ y bác sĩ chuyên môn cao, tư vấn viên và nhân viên hỗ trợ
            ...
            {[
              {
                ...
                description:
                  "Đánh giá tình trạng sức khỏe và tư vấn về phác đồ điều trị phù hợp",
              },
              {
                step: "2",
                title: "Xét Nghiệm",
                description:
                  "Thực hiện các xét nghiệm cần thiết để xác định tình trạng và lựa chọn thuốc",
              },
              {
                step: "3",
                title: "Bắt Đầu Điều Trị",
                description:
                  "Bắt đầu điều trị ARV với sự theo dõi chặt chẽ của bác sĩ",
              },
              {
                step: "4",
                title: "Theo Dõi Định Kỳ",
                description:
                  "Kiểm tra định kỳ và điều chỉnh phác đồ khi cần thiết",
              },
            ].map((item, index) => (
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12">
          Lợi Ích Khi Điều Trị Tại Chúng Tôi
        </h2>
